// OpenAPI 3.1.2 "source of truth" for LS CRM Public API (Integrations).
//
// NOTE:
...
export function getPublicApiOpenApiDocument(): OpenApiDocument {
  return {
    openapi: '3.1.2',
    info: {
      title: 'LS CRM Public API',
      version: 'v1',
      description:
        'API pública do LS CRM para integrações (n8n/Make). Produto em primeiro lugar: copiar → colar → testar.',
    },
